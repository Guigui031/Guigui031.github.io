...
\section{Professional Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Deployed 80+ websites using Azure cloud infrastructure with Front Door, CDN, and Application Gateway services}
        \resumeItem{Implemented Kubernetes containerization and WordPress Multisite CMS for scalable web solutions}
        \resumeItem{Conducted proof-of-concept development for social media API integrations}
        \resumeItem{Identified and coordinated resolution of system bugs with external development partners}
        \resumeItem{Led technical review of AI-powered virtual assistant project for client interaction capabilities}
        \resumeItem{Evaluated chatbot functionality for personalized offer generation and agent handoff processes}
        \resumeItem{Enhanced team productivity through streamlined workflows using Jira and Confluence}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Extracted and analyzed data using SQL programming to produce accountability reports and respond to internal and media requests}
        \resumeItem{Independently handled recurring and special development mandates}
        \resumeItem{Quickly learned new software, including Microsoft Access, Microsoft Power BI, and internal tools}
      \resumeItemListEnd
